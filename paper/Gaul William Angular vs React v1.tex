...
These changes ushered in an era commonly known as ``Web 2.0.'' 

DHTML rudimentary interactivity (drag-and-drop, animations)
Websites became more data-driven

Schlensker


% - Static &rarr; Dynamic
% - Pages and Links &rarr; Single-Page Applications (SPAs)
% - Desktop &rarr; Desktop, Mobile, Tablet, Watch...
% - Web Presence &rarr; Integration
